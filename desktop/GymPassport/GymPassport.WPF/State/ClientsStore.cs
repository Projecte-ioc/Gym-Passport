...
namespace GymPassport.WPF.State
{
    public class ClientsStore
    {
        ...
        {
            IEnumerable<Client> clients = await _getAllClientsQuery.Execute(_accountStore.CurrentAccount.Token);
        ...
        {
            await _createClientCommand.Execute(_accountStore.CurrentAccount.Token, client);
        ...
        {
            await _updateClientCommand.Execute(_accountStore.CurrentAccount.Token, client);
        ...
        {
            await _deleteClientCommand.Execute(_accountStore.CurrentAccount.Token, username);
