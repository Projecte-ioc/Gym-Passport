...
{
    public class EditGymEventViewModel : ViewModelBase
    {
        private int _id;
        public int Id
        {
        ...
        public int GymEventId { get; }

        public ICommand SubmitCommand { get; }
        public ICommand CancelCommand { get; }

        public EditGymEventViewModel(GymEvent gymEvent, GymEventsStore _gymEventsStore, ModalNavigationStore modalNavigationStore)
        {
            GymEventId = gymEvent.Id;
