...
public class NormalUserTest {
    ...
    public void normalUserTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextLog), withText("ivan33usr"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("ivan33us"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.editTextLog), withText("ivan33us"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.editTextLog), withText("ivan33us"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("ivan33usr"));
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.editTextLogPsw), withText("ivan33pswd"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("ivan33psw"));

        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editTextLogPsw), withText("ivan33psw"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
