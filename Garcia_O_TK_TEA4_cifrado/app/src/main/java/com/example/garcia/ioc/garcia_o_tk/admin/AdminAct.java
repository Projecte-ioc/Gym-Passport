...
import com.example.garcia.ioc.garcia_o_tk.admin.clients.Clients;
import com.example.garcia.ioc.garcia_o_tk.admin.clients.altaBaixaClients;
import com.example.garcia.ioc.garcia_o_tk.admin.events.EventsAdmin;
import com.example.garcia.ioc.garcia_o_tk.admin.perfil.PerfilAdmin;
...
public class AdminAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnEvents=findViewById(R.id.button_events);
        btnEvents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Iniciem una altra activity i tornem a pasar el TOKEN, servirà per poder fer modificacions a les dades del perfil.
                Intent intent = new Intent(getApplicationContext(), EventsAdmin.class);
                intent.putExtra("TOKEN", authToken);
                startActivity(intent);
                finish();
