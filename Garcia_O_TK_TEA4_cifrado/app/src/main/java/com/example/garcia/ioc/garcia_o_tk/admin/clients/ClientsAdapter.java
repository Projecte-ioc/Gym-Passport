 ...
 * Adaptador per poder carregar amb l'XML dynamic_cardview el recyclerView les dades de l'objecte ClientsInfo.
 */
public class ClientsAdapter extends RecyclerView.Adapter<ClientsAdapter.ViewHolder> {
    ...
    public ClientsAdapter(List<ClientsInfo> clients) {this.clients = clients;}
